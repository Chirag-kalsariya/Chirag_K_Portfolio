    ...
    return (
        <>
            <svg width="800px" height="800px" viewBox="0 0 256 256" version="1.1"
                ...
                <g>
                    <path
                        d="M70.534,69.696 L53.988,53.15 L54.058,172.75 L54.256,178.34 C54.338,180.97 54.826,183.938 55.64,187.014 L186.744,233.244 L219.516,218.724 L219.528,218.684 L70.534,69.696" fill="#00D2B8">
                    </path>
                    <path
                    ...
                    <path
                        d="M3.034,130.116 C-1.202,134.638 0.902,143.966 7.722,150.838 L37.14,180.5 L55.64,187.014 C54.826,183.938 54.338,180.97 54.256,178.34 L54.058,172.75 L53.988,53.15 L3.034,130.116 Z" fill="#0081C6">
                    </path>
                    <path
                        d="M187.82,54.686 C184.744,53.9 181.794,53.414 179.12,53.33 L173.212,53.126 L53.988,53.142 L219.544,218.684 L219.558,218.684 L234.098,185.88 L187.82,54.686" fill="#0079B3">
                    </path>
                    <path
                    ...
                    <path
                        d="M181.338,36.298 L151.684,6.862 C144.826,0.068 135.494,-2.046 130.984,2.178 L53.988,53.142 L173.212,53.126 L179.12,53.33 C181.794,53.414 184.744,53.9 187.82,54.686 L181.338,36.298 L181.338,36.298 Z" fill="#00D2B8">
                    </path>
                </g>
            </svg>
        </>
...
export const Scala: React.FC = () => {
    return (
        <>
            <svg width="800px" height="800px" viewBox="-80 0 416 416" version="1.1"
                ...
                <g>
                    ...
                    <path d="M0,224 L0,128 C0,136 256,152 256,192 L256,192 L256,288 C256,248 0,232 0,224"
                        fill="url(#linearGradient-2)"
                        transform="translate(128.000000, 208.000000) scale(1, -1) translate(-128.000000, -208.000000) ">
                    </path>
                    <path d="M0,96 L0,0 C0,8 256,24 256,64 L256,64 L256,160 C256,120 0,104 0,96"
                        fill="url(#linearGradient-2)"
                        transform="translate(128.000000, 80.000000) scale(1, -1) translate(-128.000000, -80.000000) ">
                    </path>
                    <path d="M0,352 L0,256 C0,264 256,280 256,320 L256,320 L256,416 C256,376 0,360 0,352"
                        fill="url(#linearGradient-2)"
...
export const PHP: React.FC = () => {
    return (
        <>
            <svg width="800px" height="800px" viewBox="0 -61 256 256" xmlns="http://www.w3.org/2000/svg">
                <g fill-rule="evenodd">
