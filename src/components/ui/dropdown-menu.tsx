...
function DropdownMenuLabel({
	...
	return (
		<DropdownMenuPrimitive.Label data-slot="dropdown-menu-label" data-inset={inset} className={cn('text-muted-foreground px-1.5 py-1 text-xs font-medium data-[inset]:pl-8', className)} {...props} />
	);
}
