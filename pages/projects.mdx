...
<div style={{ display: "grid", gridTemplateColumns: "auto auto", gap: "16px", marginTop: "14px" }}>
    <IconCard iconComponent={<Upwork />} iconLabel="Upwork" cardLink="https://www.upwork.com/freelancers/chiragkalsariya" />
    <IconCard iconComponent={<Fiverr />} iconLabel="Fiverr" cardLink="https://www.fiverr.com/chirag_ka" />
    <IconCard iconComponent={<Freelancer />} iconLabel="Freelancer" cardLink="https://www.freelancer.com/u/Chirag3673" />
</div>
