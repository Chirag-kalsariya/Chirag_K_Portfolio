...
description: Chirag kalsariya freelancing projects and work experience.
...
<div style={{ display: "grid", gridTemplateColumns: "auto auto", gap: "16px", marginTop: "14px" }}>
    <CustomCard iconComponent={<Upwork />} iconLabel="Upwork" cardLink="https://www.upwork.com/freelancers/chiragkalsariya" />
    <CustomCard iconComponent={<Fiverr />} iconLabel="Fiverr" cardLink="https://www.fiverr.com/chirag_ka" />
    <CustomCard iconComponent={<Freelancer />} iconLabel="Freelancer" cardLink="https://www.freelancer.com/u/Chirag3673" />
</div>
